  ...
  (
    ...
    return (
      <Card
        ...
        style={cardCss}
        className={cn(
          "flex flex-col rounded-3xl border-0 p-8 min-h-full h-[400px]",
          isAccent
      ...
      >
        <CardHeader className="p-0">
          ...
          <CardDescription
            className={cn(
              "pt-6 text-left font-bold uppercase tracking-wider text-xs",
  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "relative w-full max-w-lg overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-shadow",
          className
        )}
        {...rest}
      >
